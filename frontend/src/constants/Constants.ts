...
export const SELECT_QUIZ_OPTION = 'Select the answer';
export const VIEW_HISTORIQUE = 'View history';
export const GO_TO_HOMEPAGE = 'Go to the Homepage';
...
export const QUIZ_PLAYER = 'Joueur';
export const QUIZ_PLAYERS = 'Joueurs';
export const QUIZ_PLAYED_AT = 'Date';
export const QUIZ_PERCENTAGE = 'Pourcentage';
export const QUIZ_CORRECT_QUESTIONS = 'Questions correctes';
export const QUIZ_MISSED_QUESTIONS = 'Missed questions';

export const USER_NAME = 'Nom';
export const USER_PROVIDER = 'Source';
export const USER_EMAIL = 'Email';
export const USER_HISTORY = 'Historique';
export const USER_SCORE = 'Votre Score';
...
export const DELETE_CONFIRMATION_MESSAGE = 'Do you want to confirm deletion?';
export const DELETE_WITH_SUCCESS = 'Deleted successfully';
export const IMPORT_WITH_SUCCESS = 'Imported successfully';
export const LOGOUT_WITH_SUCCESS = 'Logged out successfully';
...
export const BANNER_SUBMESSAGE = 'With new quizzes added regularly, there\'s always something new to discover. Try a new quiz every day and see how much you can learn!';
export const BANNER_BUTTON = 'Discover our quizzes';
...
export const MANAGE_QUIZZES_PAGE_TITLE = 'Quiz';
